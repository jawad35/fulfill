                            ...
                            <div className="row align-items-center">
                                <div className="col-xl-6 col-lg-7 col-md-5">
                                    <div className="footer-copyright__content">
                                        <span>Copyright {new Date().getFullYear()} <Link href="/">©fulfillneeds</Link>. All rights reserved. Developed by <Link href="https://themeforest.net/user/alithemes/portfolio"> AliThemes</Link>.</span>
                                    </div>
                                </div>
